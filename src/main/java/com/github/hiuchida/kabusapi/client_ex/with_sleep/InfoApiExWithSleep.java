...
public class InfoApiExWithSleep {
	...
	public ApiSoftLimitResponse apisoftlimitGet(String X_API_KEY) throws ApiException, InterruptedException {
		try {
	...
	public BoardSuccessEx boardGet(String X_API_KEY, String symbol, ExchangeCode ec) throws ApiException, InterruptedException {
		try {
